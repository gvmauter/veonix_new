...
(function(factory) {
  ...
  DmUploaderFile.prototype.upload = function()
  {
    ...
    file.jqXHR = $.ajax({
      ...
      success: function(data) { 
        let urlNow = $(".fileUrl").val()
        $(".fileUrl").val(urlNow + "https://veonix.ru/backend/"+data.path+"   ")
        file.onSuccess(data);
        return data.path;
       },
  ...
  DmUploader.prototype.startAll = function(formID)
  {
