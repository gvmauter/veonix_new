...
<xsl:stylesheet version="2.0" xmlns:sitemap="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <html>
            <head>
                <title>Файл карты сайта</title>
                <script type="text/javascript" src="http://yandex.st/jquery/1.8.3/jquery.min.js"/>
                <script type="text/javascript" src="/bitrix/js/artofbx.xmlsitemap/jquery.tablesorter.min.js"/>
                <script type="text/javascript" src="/bitrix/js/artofbx.xmlsitemap/xmlsitemap.xsl.js"/>
                <link href="/bitrix/js/artofbx.xmlsitemap/xmlsitemap.xsl.css" type="text/css" rel="stylesheet"/>
            </head>
            ...
            <body>
                ...
                <div id="footer">
                    <p>(c) Generated by <a href="https://marketplace.1c-bitrix.ru/solutions/artofbx.xmlsitemap/" target="_blank">artofbx.xmlsitemap</a>.</p>
                </div>
            </body>
        </html>
    </xsl:template>
    ...
    <xsl:template name="sitemapTable">
        <div id="information">
            <p>Количество адресов в этой карте сайта:
        ...
        <table class="tablesorter sitemap">
            <thead>
                <tr>
                    <th>URL location</th>
                    <th>Дата последнего изменения</th>
                    <th>Изменить частоту обновления</th>
                    <th>Приоритет</th>
                </tr>
            </thead>
            <tbody>
