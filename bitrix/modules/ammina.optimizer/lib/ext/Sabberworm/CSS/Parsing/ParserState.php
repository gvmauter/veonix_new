...
class ParserState
{
    ...
    {
        $sPeek = $this->peek(amopt_strlen($sString));
        return ($sPeek == '')
            ? false
    ...
    {
        if (is_string($mValue)) {
            $iLineCount = amopt_substr_count($mValue, "\n");
            ...
            $iLineCount = amopt_substr_count($sResult, "\n");
            $this->iLineNo += $iLineCount;
    ...
    public function consumeComment()
    {
        ...
        if ($mComment !== false) {
            ...
            return new Comment(amopt_substr($mComment, 1), $iLineNo);
        }
    ...
    private function strtolower($sString)
    {
        if ($this->oParserSettings->bMultibyteSupport) {
            ...
            return amopt_strtolower($sString);
        }
    }
    ...
    private function strpos($sString, $sNeedle, $iOffset)
    {
        if ($this->oParserSettings->bMultibyteSupport) {
            ...
            return amopt_strpos($sString, $sNeedle, $iOffset);
        }
    }
}
