...
//		$this->file_edit = str_replace('list.php', 'edit.php', $this->file);
		$this->tableID = 'tbl_sva_'.substr($this->file, 0, -4);
...
//			"BUTTONS" => Array(
////				array(
////					"VALUE" => \Bitrix\Main\Localization\Loc::getMessage('SVA_BTN_PROCESS_STOP'),
////					"ID" => "sva_btn_process_stop"
////				),
////				array(
////					"VALUE" => \Bitrix\Main\Localization\Loc::getMessage('SVA_BTN_PROCESS_START'),
////					"ID" => "sva_btn_process_start"
////				),
//				array(
//					"VALUE" => \Bitrix\Main\Localization\Loc::getMessage('SVA_BTN_PROCESS_CANCEL'),
//					"ID" => "sva_btn_process_cancel"
//				)
//			),
//			"DETAILS" => GetMessage("SVA_PROGRESS_BAR", array(
//					"#COMRESSED_FILES_COUNT#" => "",
//					"#FILES_COUNT#" => "",
//				)) . '#PROGRESS_BAR#',
//			"HTML" => true,
//			"PROGRESS_TOTAL" => 100,
