...
class sva_tinypng extends CModule
{
    ...
    public function InstallDB() {
        ...
        // Setting settings
        COption::SetOptionString($this->MODULE_ID, "tiny_png_compress_all_files", "Y");
        COption::SetOptionString($this->MODULE_ID, "tiny_png_compress_iblock_element", "Y");
        COption::SetOptionString($this->MODULE_ID, "tiny_png_compress_iblock_section", "Y");
    ...
    public function UnInstallDB() {
        ...
        if ($_REQUEST['savedata'] != 'Y') {
            ...
            COption::RemoveOption($this->MODULE_ID, "tiny_png_compress_all_files");
            COption::RemoveOption($this->MODULE_ID, "tiny_png_compress_iblock_element");
            COption::RemoveOption($this->MODULE_ID, "tiny_png_compress_iblock_section");
            COption::RemoveOption($this->MODULE_ID, "tiny_png_api_key");
