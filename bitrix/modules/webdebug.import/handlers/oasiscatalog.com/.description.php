...
$arHandler = array(
	'CODE' => 'OASISCATALOG', // Символьный код текущего обработчика - обязательное поле
	'TITLE' => GetMessage('WDI_OASISCATALOG_TITLE'), // Краткое название текущего обработчика - обязательное поле
	'NAME' => GetMessage('WDI_OASISCATALOG_NAME'), // Название текущего обработчика - обязательное поле
	'DESCRIPTION' => GetMessage('WDI_OASISCATALOG_DESC'), // Описание текущего обработчика
	...
	'CLASS_NAME' => 'CWDI_OasisCatalog', // Имя основного класса обработчика (класс должен находиться в class.php)
