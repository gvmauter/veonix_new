...
$aMenu = [
    ...
    'more_url'  => [
        'mcart_xls_index.php',
        'mcart_xls_profile_edit.php',
        'mcart_xls_profile_columns.php',
        'mcart_xls_profile_column_edit.php',
        'mcart_xls_profile_import.php',
        'mcart_xls_profile_edit.php',
        'mcart_xls_profile_edit_step_1.php',
        'mcart_xls_profile_edit_step_2.php',
        'mcart_xls_profile_edit_step_3.php'
    ],
    "items"     => []
];
return $aMenu;
