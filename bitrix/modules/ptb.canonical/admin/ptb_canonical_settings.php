...
$aTabs = array(
    ...
    array(
        "DIV" => "ptb_canonical_debug_tab",
        "TAB" => Loc::getMessage("PTB_CANONICAL_SETTINGS_TAB_DEBUG"),
        "TITLE" => Loc::getMessage("PTB_CANONICAL_SETTINGS_TAB_DEBUG")
    )
);
...
$bDebug = Option::get($moduleId, 'ptb_canonical_debug', 'N') == 'Y';
?>
	<tr id="ptb_canonical_tr_index_disable">
		<td class="adm-detail-content-cell-l"><label for="ptb_index_disable"><?=Loc::getMessage("PTB_CANONICAL_SETTINGS_INDEX_DISABLE");?></label>:</td>
		<td class="adm-detail-content-cell-r"><input type="checkbox" value="Y"
			id="ptb_index_disable"
			<?=Option::get($moduleId, 'ptb_index_disable', 'N', '-') == 'Y' ? ' checked' : ''?>
			name="ptb_index_disable" />&nbsp;<span
			class="adm-favorites-cap-hint-text"><?=Loc::getMessage('PTB_CANONICAL_SETTINGS_INDEX_DISABLE_HINT') ?></span></td>
	</tr>
	
	<tr id="ptb_canonical_tr_domain_disable">
		<td class="adm-detail-content-cell-l"><label for="ptb_domain_disable"><?=Loc::getMessage("PTB_CANONICAL_SETTINGS_DOMAIN_DISABLE");?></label>:</td>
		<td class="adm-detail-content-cell-r"><input type="checkbox" value="Y"
			id="ptb_domain_disable"
			<?=Option::get($moduleId, 'ptb_domain_disable', 'N', '-') == 'Y' ? ' checked' : ''?>
			name="ptb_domain_disable" /></td>
	</tr>
	...
	<tr id="ptb_canonical_tr_active_all"
		...
		<td class="adm-detail-content-cell-r"><input type="checkbox" value="Y"
			...
			<?=Option::get($moduleId, 'ptb_canonical_active', 'Y', '-') == 'Y' ? ' checked' : ''?>
	...
	<tr id="ptb_canonical_tr_default_all"
		...
		<td class="adm-detail-content-cell-r"><input type="checkbox" value="Y"
			...
			<?=Option::get($moduleId, 'ptb_canonical_default', 'Y', '-') == 'Y' ? ' checked' : ''?>
...
?>
    <tr>
		<td class="adm-detail-content-cell-l"><label
			for="ptb_canonical_debug"><?=Loc::getMessage("PTB_CANONICAL_SETTINGS_DEBUG");?></label>:</td>
		<td class="adm-detail-content-cell-r"><input type="checkbox" value="Y"
			id="ptb_canonical_debug"
        <?=$bDebug ? ' checked' : ''?> name="ptb_canonical_debug" /></td>
	</tr>
<?
$tabControl->Buttons();
?>
